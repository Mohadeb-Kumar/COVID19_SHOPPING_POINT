	...
	<body class="back">
		<div>
			...
			<br/>
				...
				<h2 class="charge_reg_h2">Volunteer Registration</h2>
					<?php
					...
					<button type="submit" class="reg_btn" name="registration">Registation as Volunteer</button>
					</form>
					
					<br/>
					<label class="reg_lable">Have already an account?<a href="volunteer_login.php"> Login here</a></label><br>
