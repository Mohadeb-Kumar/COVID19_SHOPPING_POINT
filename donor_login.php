...
<html>
	...
	<body class="back">
		<div>
			...
			<br/>
				<div class="donor_log_div">
				<h2 style="color:#ffffff;" class="charge_reg_h2">Donor Login</h2>
					<?php
			...
			?>					
					...
					<button type="submit" class="reg_btn" name="login">Login as Login</button>
					</form>
					
					<br/>
					<label class="reg_lable">Don't have an account?<a href="donor_reg.php"> Registration Now</a></label><br>
