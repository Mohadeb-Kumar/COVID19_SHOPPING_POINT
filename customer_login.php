	...
	<body class="back">
		<div>
			...
			<br/>
				...
				<h2 class="charge_reg_h2">Customer Login</h2>
					<?php
			...
			?>					
					...
					<button type="submit" class="reg_btn" name="login">Login as Customer</button>
					</form>
					
					<br/>
					<label class="reg_lable">Don't have an account?<a href="charge_customer_reg.php"> Registration Now</a></label><br>
